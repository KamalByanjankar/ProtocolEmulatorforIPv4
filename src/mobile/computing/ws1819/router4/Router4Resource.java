...
public class Router4Resource
{
	...
	public String createMessage(String messageAsJSONstring) throws JsonParseException, JsonMappingException, IOException
	{
		...
		message.setSourceId("10.10.40.40");
		...
		System.out.println("Connected direct to the Server .... ");
		...
		System.out.println("Route " + router4Id + " -------> " + destinationId);
		System.out.println("\nData :  " + message.data);		
