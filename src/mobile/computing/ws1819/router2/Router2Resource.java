...
import java.util.Scanner;
	...
	public class Router2Resource
	{
		...
		public String createMessage(String messageAsJSONstring) throws JsonParseException, JsonMappingException, IOException
		{
			...
			message.setSourceId("10.10.20.20");
			...
			System.out.print("\nEnter the cost for Router 3 with IP " + router3Id + " : ");
			int R3 = sc.nextInt();
			
			System.out.print("Enter the cost for Router 4 with IP " + router4Id + " : ");
			int R4 = sc.nextInt();
			...
			if(message.getTtl()-1>0) {
				...
				if (R3 <= R4)
				{
					...
					System.out.println("\nConnection established with Router 3 .... ");
					System.out.println("Connection established from " + router2Id + " -------> " + router3Id + " Cost = " + R3);
					...
					System.out.println("\nData :  " + message.data);
					System.out.println("Route " +router2Id+ "----> "+router3Id+ " Cost : " +nextCost);
				}
				...
				else
				{
					...
					System.out.println("\nConnection established with Router 4 .... ");
					System.out.println("Connection established from " + router2Id + " -------> " + router4Id + " Cost = " + R4);
					...
					System.out.println("\nReceived POST Request with JSON String:\n" + messageAsJSONstring);
					System.out.println("\nData :  " + message.data);
					System.out.println("Route " +router2Id+ "----> "+router4Id+ " Cost : " +nextCost);
				}
